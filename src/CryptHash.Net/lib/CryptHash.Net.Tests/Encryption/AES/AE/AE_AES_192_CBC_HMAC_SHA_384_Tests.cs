...
namespace CryptHash.Net.Tests.Encryption.AES.AE
{
    ...
    {
        private readonly AE_AES_192_CBC_HMAC_SHA_384 _aes192cbcHmacSha384 = new AE_AES_192_CBC_HMAC_SHA_384();
        ...
        public void Test_DecryptString_without_encryption_data_appended()
        {
            ...
            if (aesEncryptionResult.Success)
            {
                aesDecryptionResult = _aes192cbcHmacSha384.DecryptString(aesEncryptionResult.EncryptedDataBytes, System.Text.Encoding.UTF8.GetBytes(_password),
        ...
        public void Test_DecryptFile_without_append_encryption_data()
        {
            ...
            if (aesEncryptionResult.Success)
            {
                aesDecryptionResult = _aes192cbcHmacSha384.DecryptFile(testFilePath, testFilePath, System.Text.Encoding.UTF8.GetBytes(_password), false, hasEncryptionDataAppendedInInputFile: appendEncryptionData,
        ...
        public void Test_Encrypt_Decrypt_String_without_password()
        {
            ...
            var aesEncryptionResult = _aes192cbcHmacSha384.EncryptString(System.Text.Encoding.UTF8.GetBytes(_testString));

            if (aesEncryptionResult.Success)
            {
                aesDecryptionResult = _aes192cbcHmacSha384.DecryptString(aesEncryptionResult.EncryptedDataBytes, aesEncryptionResult.Key, aesEncryptionResult.IV,
