...
namespace CryptHash.Net.Tests.Encryption.AES.AE
{
    ...
    {
        private readonly AE_AES_256_CBC_HMAC_SHA_512 _aes256cbcHmacSha512 = new AE_AES_256_CBC_HMAC_SHA_512();
        ...
        public void Test_DecryptString_without_encryption_data_appended()
        {
            ...
            if (aesEncryptionResult.Success)
            {
                aesDecryptionResult = _aes256cbcHmacSha512.DecryptString(aesEncryptionResult.EncryptedDataBytes, System.Text.Encoding.UTF8.GetBytes(_password),
        ...
        public void Test_DecryptFile_without_append_encryption_data()
        {
            ...
            if (aesEncryptionResult.Success)
            {
                aesDecryptionResult = _aes256cbcHmacSha512.DecryptFile(testFilePath, testFilePath, System.Text.Encoding.UTF8.GetBytes(_password), false, hasEncryptionDataAppendedInInputFile: appendEncryptionData,
        ...
        public void Test_Encrypt_Decrypt_String_without_password()
        {
            ...
            var aesEncryptionResult = _aes256cbcHmacSha512.EncryptString(System.Text.Encoding.UTF8.GetBytes(_testString));
