...
namespace CryptHash.Net.Tests.Encryption.AES.AEAD
{
    ...
    public class AEAD_AES_192_GCM_Tests
    {
        ...
        public void Test_DecryptString_without_encryption_data_appended_without_associated_data()
        {
            ...
            {
                aesDecryptionResult = _aes192gcm.DecryptString(aesEncryptionResult.EncryptedDataBytes, System.Text.Encoding.UTF8.GetBytes(_password), null, hasEncryptionDataAppendedInInput: appendEncryptionData,
        ...
        public void Test_DecryptString_without_encryption_data_appended_with_associated_data()
        {
            ...
            if (aesEncryptionResult.Success)
            {
                aesDecryptionResult = _aes192gcm.DecryptString(aesEncryptionResult.EncryptedDataBytes, System.Text.Encoding.UTF8.GetBytes(_password), System.Text.Encoding.UTF8.GetBytes(associatedData), hasEncryptionDataAppendedInInput: appendEncryptionData,
                    aesEncryptionResult.Tag, aesEncryptionResult.Salt, aesEncryptionResult.Nonce);
