...
namespace CryptHash.Net.Hash.Hash
{
    public class SHA256 : HashBase
    {
        ...
        {
            return base.ComputeHash(Enums.HashAlgorithm.SHA256, bytesToComputeHash, offset, count);
        }
        ...
        {
            return base.ComputeHash(Enums.HashAlgorithm.SHA256, stringToComputeHash, offset, count);
        }
        ...
        {
            return base.ComputeFileHash(Enums.HashAlgorithm.SHA256, filePathToComputeHash, offset, count);
        }
        ...
        {
            return base.VerifyHash(Enums.HashAlgorithm.SHA256, hashBytes, bytesToVerifyHash, offset, count);
        }

        /// <summary>
        /// Verifies the SHA256 hash of an input string.
        /// </summary>
        /// <param name="hashHexString">The pre-computed SHA256 hash hexadecimal encoded string.</param>
        ...
        {
            return base.VerifyHash(Enums.HashAlgorithm.SHA256, hashHexString, stringToVerifyHash, offset, count);
        }
        ...
        {
            return base.VerifyFileHash(Enums.HashAlgorithm.SHA256, hashHexString, filePathToVerifyHash, offset, count);
        }
        ...
        {
            return base.VerifyFileHash(Enums.HashAlgorithm.SHA256, hashBytes, filePathToVerifyHash, offset, count);
        }
    }
}
