...
namespace CryptHash.Net.Hash.Hash
{
    public class SHA256 : HashBase
    {
        ...
        {
            return base.VerifyHash(Enums.HashAlgorithm.SHA256, hashHexString, stringToVerifyHash);
        }
        ...
        {
            return base.VerifyFileHash(Enums.HashAlgorithm.SHA256, hashHexString, filePathToVerifyHash);
        }
