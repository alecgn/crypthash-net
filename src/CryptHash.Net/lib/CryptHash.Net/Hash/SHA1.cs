...
namespace CryptHash.Net.Hash.Hash
{
    public class SHA1 : HashBase
    {
        ...
        {
            return base.VerifyFileHash(Enums.HashAlgorithm.SHA1, base64HashString, sourceFilePath);
        }

        public GenericHashResult VerifyFileHash(byte[] hashBytes, string sourceFilePath)
        {
            return base.VerifyFileHash(Enums.HashAlgorithm.SHA1, hashBytes, sourceFilePath);
        }
    }
}
