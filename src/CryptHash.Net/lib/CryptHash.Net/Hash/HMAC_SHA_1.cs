...
namespace CryptHash.Net.Hash
{
    ...
    {
        /// <summary>
        /// Computes the HMAC of an input byte array using a 160 bit key.
        /// </summary>
        ...
        {
            return base.ComputeHMAC(Enums.HashAlgorithm.SHA1, bytesToComputeHMAC, key);
        }

        /// <summary>
        /// Computes the HMAC of an input string using a 160 bit key.
        /// </summary>
        ...
        {
            return base.ComputeHMAC(Enums.HashAlgorithm.SHA1, stringToComputeHMAC, key);
        }

        /// <summary>
        /// Computes the HMAC of an input file using a 160 bit key.
        /// </summary>
        ...
        {
            return base.ComputeFileHMAC(Enums.HashAlgorithm.SHA1, filePathToComputeHMAC, key);
        }


        /// <summary>
        /// Verifies the HMAC of an input byte array using a 160 bit key.
        /// </summary>
        ...
        /// <summary>
        /// Verifies the HMAC of an input string using a 160 bit key.
        /// </summary>
        ...
        /// <summary>
        /// Verifies the HMAC of an input file using a 160 bit key.
        /// </summary>
        /// <param name="base64HMACString">The pre-computed HMAC base64 string.</param>
