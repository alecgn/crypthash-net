...
namespace CryptHash.Net.Hash
{
    public class HMAC_SHA_512 : HMACBase
    {
        ...
        {
            return base.ComputeHMAC(Enums.HMACAlgorithm.HMACSHA512, bytesToComputeHMAC, key, offset, count);
        }
        ...
        {
            return base.ComputeHMAC(Enums.HMACAlgorithm.HMACSHA512, stringToComputeHMAC, key, offset, count);
        }
        ...
        {
            return base.ComputeFileHMAC(Enums.HMACAlgorithm.HMACSHA512, filePathToComputeHMAC, key, offset, count);
        }
        ...
        {
            return base.VerifyHMAC(Enums.HMACAlgorithm.HMACSHA512, hmacBytes, bytesToVerifyHMAC, key, offset, count);
        }
        ...
        {
            return base.VerifyHMAC(Enums.HMACAlgorithm.HMACSHA512, hmacHexString, stringToVerifyHMAC, key, offset, count);
        }
        ...
        {
            return base.VerifyFileHMAC(Enums.HMACAlgorithm.HMACSHA512, hmacHexString, filePathToVerifyHMAC, key, offset, count);
        }
        ...
        {
            return base.VerifyFileHMAC(Enums.HMACAlgorithm.HMACSHA512, hmacBytes, sourceFilePath, key, offset, count);
        }
    }
}