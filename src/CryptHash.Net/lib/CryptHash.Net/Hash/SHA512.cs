...
namespace CryptHash.Net.Hash.Hash
{
    public class SHA512 : HashBase
    {
        ...
        /// </summary>
        /// <param name="base64HashString">The pre-computed SHA512 hash base64 encoded string.</param>
        ...
        {
            return base.VerifyFileHash(Enums.HashAlgorithm.SHA512, base64HashString, filePathToVerifyHash);
        }
