...
namespace CryptHash.Net.Encryption.AES.AE
{
    public class AE_AES_192_CBC_HMAC_SHA_384 : AesBase
    {
        ...
        /// <summary>
        /// Decrypts a byte array of the string using AES with a 128 bits key in CBC mode with HMACSHA256 authentication.
        /// </summary>
        /// <param name="encryptedStringBytes">The input byte array of the string to decrypt.</param>
        /// <param name="encryptionKey">The previously generated byte array of the encryption key used to encrypt data.</param>
        /// <param name="IV">The previously generated byte array of the Initialization Vector used to initialize the first block.</param>
        /// <param name="authenticationKey">The previously generated byte array of the authentication key.</param>
