...
namespace CryptHash.Net.Encryption.AES.AE
{
    public class AE_AES_256_CBC_HMAC_SHA_384 : AesBase
    {
        ...
        /// <summary>
        /// Encrypts an input string using AES with a 256 bits key in CBC mode with HMACSHA384 authentication, deriving the key from a provided password string.
        /// </summary>
        ...
        /// <summary>
        /// Encrypts an input string using AES with a 256 bits key in CBC mode with HMACSHA384 authentication, deriving the key from a provided SecureString with the password.
        /// </summary>
        /// <param name="plainString">The input plain string to encrypt.</param>
        ...
        /// <summary>
        /// Encrypts an input byte array of the string using AES with a 256 bits key in CBC mode with HMACSHA384 authentication, deriving the key from a provided SecureString with the password.
        /// </summary>
        ...
        /// <summary>
        /// Encrypts an input byte array of the string using AES with a 256 bits key in CBC mode with HMACSHA384 authentication, deriving the key from a provided byte array of the password.
        /// </summary>
        /// <param name="plainStringBytes">The input byte array of the string to encrypt.</param>
        ...
        /// <summary>
        /// Encrypts an input byte array of the string using AES with a 256 bits key in CBC mode with HMACSHA384 authentication.
        /// </summary>
        /// <param name="plainStringBytes">The input byte array of the string to encrypt.</param>
        ...
        /// <summary>
        /// Decrypts a base64 encoded input string using AES with a 256 bits key in CBC mode with HMACSHA384 authentication, deriving the key from a provided password string.
        /// </summary>
        ...
        /// <summary>
        /// Decrypts a base64 encoded input string using AES with a 256 bits key in CBC mode with HMACSHA384 authentication, deriving the key from a provided password in a SecureString.
        /// </summary>
        /// <param name="base64EncryptedString">The base64 encoded input string to decrypt.</param>
        ...
        /// <summary>
        /// Decrypts a byte array of the string using AES with a 256 bits key in CBC mode with HMACSHA384 authentication, deriving the key from a provided password in a SecureString.
        /// </summary>
        ...
        /// <summary>
        /// Decrypts a byte array of the string using AES with a 256 bits key in CBC mode with HMACSHA384 authentication, deriving the key from a provided byte array of the password.
        /// </summary>
        /// <param name="encryptedStringBytes">The input byte array of the string to decrypt.</param>
        ...
        /// <summary>
        /// Encrypts a file using AES with a 256 bits key in CBC mode with HMACSHA384 authentication, deriving the key from a provided password string.
        /// </summary>
        ...
        /// <summary>
        /// Encrypts a file using AES with a 256 bits key in CBC mode with HMACSHA384 authentication, deriving the key from a provided SecureString with the password.
        /// </summary>
        /// <param name="sourceFilePath">The input source file path to encrypt.</param>
        /// <param name="encryptedFilePath">The output file path to save the encrypted file. Pass null or an empty string to not generate a new file, encrypting only the input source file and mantaining its path.</param>
        /// <param name="secStrPassword">The SecureString with the password where the encryption key will be derived from.</param>
        ...
        /// <summary>
        /// Encrypts a file using AES with a 256 bits key in CBC mode with HMACSHA384 authentication, deriving the key from a provided byte array of the password.
        /// </summary>
        /// <param name="sourceFilePath">The input source file path to encrypt.</param>
        /// <param name="encryptedFilePath">The output file path to save the encrypted file. Pass null or an empty string to not generate a new file, encrypting only the input source file and mantaining its path.</param>
        /// <param name="passwordBytes">The byte array of the password where the encryption key will be derived from.</param>
        ...
        /// <summary>
        /// Decrypts a file using AES with a 256 bits key in CBC mode with HMACSHA384 authentication, deriving the key from a provided password string.
        /// </summary>
        ...
        /// <summary>
        /// Decrypts a file using AES with a 256 bits key in CBC mode with HMACSHA384 authentication, deriving the key from a provided SecureString with the password.
        /// </summary>
        /// <param name="encryptedFilePath">The input source encrypted file path do decrypt.</param>
        /// <param name="decryptedFilePath">The output file path to save the decrypted file. Pass null or an empty string to not generate a new file, decrypting only the input source encrypted file and mantaining its path.</param>
        /// <param name="secStrPassword">The SecureString with the password where the encryption key will be derived from.</param>
